% Bueno, para ser justos, también podés llegar fácilmente si vivís en la misma zona 
% del destino (caminar hace bien :running:).
% Es decir, alguien llega fácil a un destino, si vive en la misma zona en
% la que queda este destino. ¿Se podrá decir expresar esto en Prolog? 
